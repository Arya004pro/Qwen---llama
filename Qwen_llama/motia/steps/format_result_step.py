    ...
    cfg = {
        ...
        "options":{**_BASE,"indexAxis":"y",
            "plugins":{**_BASE["plugins"],"tooltip":{**_BASE["plugins"]["tooltip"],
                "callbacks":{"label":f"function(c){{return ' {p}'+c.raw.toLocaleString('en-IN',{{minimumFractionDigits:2}})}}"},
            }},
            "scales":{"x":{**_BASE["scales"]["x"],"ticks":{**_BASE["scales"]["x"]["ticks"],
                "callback":f"function(v){{return '{p}'+v.toLocaleString('en-IN')}}"}},
                "y":_BASE["scales"]["y"]},
        },
    }
        ...
        cfg = {
            ...
            "options":{**_BASE,"indexAxis":"y",
                "plugins":{**_BASE["plugins"],"legend":{"display":True,"labels":{"color":"#94a3b8"}},
                    "tooltip":{**_BASE["plugins"]["tooltip"],"callbacks":{"label":f"function(c){{return ' '+c.dataset.label+': {p}'+c.raw.toLocaleString('en-IN',{{minimumFractionDigits:2}})}}"}}},
                "scales":{"x":{**_BASE["scales"]["x"],"ticks":{**_BASE["scales"]["x"]["ticks"],"callback":f"function(v){{return '{p}'+v.toLocaleString('en-IN')}}"}},
                          "y":_BASE["scales"]["y"]},
            },
        }
